                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                     ...
                     <td colspan="1" >                      
                      ...
                      <input type="hidden" name="model_no" value="CS-CPB-2T">
                    </td>
                    <td colspan="1" >                      
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">6,500.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="6500">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-CPB-2T</strong></span></td>
                  </tr>
                   <tr>
              ...
              <!--         <input type="hidden" name="total_val" value=""> -->  <!-- id="total" -->
                   ...
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="geared_trolley_total">0.00</span></strong>
                     ...
                     <td colspan="2" id="traviling_moter_no">CS-GT_CPB-2T
                      <input type="hidden" name="traviling_moter_no_val" value="CS-GT_CPB-2T">
                     </td>
                  </tr>
                   <tr>
