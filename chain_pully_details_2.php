            ...
            <div class="card-body">
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                     ...
                     <td colspan="1" >                      
                      ...
                      <input type="hidden" name="model_no" value="CS-CPB-3T">
                    </td>
                    <td colspan="1" >                      
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">7,750.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="7750.00">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-CPB-3T</strong></span></td>
                  </tr>
                   <tr>
              ...
              <!--         <input type="hidden" name="total_val" value=""> -->  <!-- id="total" -->
                   ...
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="basic_total">0.00</span></strong><input type="hidden" value="4250" name="basic_total_val" id="basic_total_val" ></td>
                     <td colspan="2" ></td>
                  </tr>
                   <tr id="igst">
                  ...
                  <tr>
                     ...
                     <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="total_amounts">0.00</span></strong><input type="text" id="total_amounts_val" name="total_amounts_val"> </td>
                     <td colspan="2"> </td> 
                  </tr>
                  <tr>
