                ...
                <thead>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">60,500.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="60500.00">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-ECH-2T</strong></span>
                     <input type="hidden" name="model_no" value="CS-ECH-2T"></td>
                  </tr>
                   <tr>
              ...
              <!--         <input type="hidden" name="total_val" value=""> -->  <!-- id="total" -->
                   ...
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="geared_trolley_total">0.00</span></strong>
                     ...
                     <td colspan="2" id="traviling_moter_no">CS-GT_ECH-2T
                      <input type="hidden" name="traviling_moter_no_val" value="CS-GT_ECH-2T">
                     </td>
                  </tr>
                   <tr>
                     <td colspan="3"><span><strong>BASIC TOTAL</strong></span></td>
                     
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="basic_total">0.00</span></strong><input type="hidden" value="60500" name="basic_total_val" id="basic_total_val" ></td>
                     <td colspan="2" ></td>
                  </tr>
                   <tr id="igst">
