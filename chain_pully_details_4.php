                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                     ...
                     <td colspan="1" >                      
                      ...
                      <input type="hidden" name="model_no" value="CS-CPB-10T">
                    </td>
                    <td colspan="1" >                      
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">22,550.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="22550">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-CPB-10T</strong></span></td>
                  </tr>
                   <tr>
              ...
              <!--         <input type="hidden" name="total_val" value=""> -->  <!-- id="total" -->
                   ...
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="geared_trolley_total">0.00</span></strong>
                     ...
                     <td colspan="2" id="traviling_moter_no">CS-GT_CPB-10T
                      <input type="hidden" name="traviling_moter_no_val" value="CS-GT_CPB-10T
">
                     </td>
                  </tr>
                   <tr>
