              ...
              <div class="mb-3">
                  <div class="title mb-2"><i class="lni lni-angellist"></i><span>TYPE OF CRANE</span> <span style="color: red;">*</span></div>
                   <select class="form-control" name="crane_type">
                    ...
                    <option value="double_girder_semi_gntry_crane">DOUBLE GIRDER SEMI GANTRY CRANE(UPTO 110T)</option>
                ...
                <button class="btn btn-success" name="gantry_upload" type="submit">Upload</button>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body">
              ...
              <!-- <form action="action.php" method="POST" enctype="multipart/form-data"> -->
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" name="cantilever" placeholder="Please Furnish Details With Both/One Side" type="text">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control mb-2" placeholder="Please Fill Manual In Case of Manual Operation" name="speed_lt">
                </div>
                <div class="mb-3">
                ...
                <button class="btn btn-success w-100" name="gantry_text" type="submit">SUBMIT & REVIEW</button>
