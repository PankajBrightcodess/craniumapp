<?php 
  ...
  $msg = "";
    ...
    $id=$abcd['id'];
    // print_r($id);die;
   $id  =$_SESSION['jib_lasttext_id'];
    $query="SELECT * FROM `myc_jibcrane` where `id`='$id'";
                ...
                <table class="table table-bordered " style="font-size: 10px;">
                  <thead>
                    ...
                    <tr>
                     ...
                     <tr>
                      <th><span>TYPE OF HOIST</span></th>
                      <th><?php echo $preview['type_of_hoist'];?></th>
                    </tr>
                     <tr>
                      <th><span>ARM LENGTH (IN METERS)</span></th>
                      <th><?php echo $preview['arm'];?></th>
                    </tr>
                    <tr>
                      <th><span>LIFTING HEIGHT (IN METERS)</span></th>
                      <th><?php echo $preview['lifting_height'];?></th>
                    </tr>
                     <tr>
                      <th><span>SPEED (OPTIONAL)- IN MTRS./MIN</span></th>
                      <th><?php echo $preview['mh'];?>/<?php echo $preview['ct'];?></th>
                    </tr>
                    <tr>
                      <th><span>SWIVELING</span></th>
                      <th><?php echo $preview['swivel'];?></th>
                    </tr>
                     <tr>
                      <th><span>SWIVELING DEGREE</span></th>
                      <th><?php echo $preview['swivel_degree'];?></th>
                    </tr>
                    <tr>
             ...
             <!--    <div class="mb-3">
               ...
               <!--   <div class="mb-3">
                ...
                <input type="hidden" name="amount" value="350">
                 <button class="btn btn-success w-100" name="jib_payment" type="submit">PROCEED FOR PAYMENT AGAINST SUBSCRIPTION</button>
