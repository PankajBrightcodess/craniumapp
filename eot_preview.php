<?php 
  ...
  $msg = "";
    ...
    $id=$abcd['id'];
    // print_r($id);die;
   $id  =$_SESSION['eotcrane_lasttext_id'];
    $query="SELECT * FROM `myc_eotrequestform` where `id`='$id'";
            ...
            <div class="card-body">
                  ...
                  <thead>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <th><?php echo $preview['abv_floor_mh'];?></th>
                    </tr>
                    <tr>
                     ...
                     <tr>
                      <th><span>COLUMN TO COLUMN DISTANCE (IN METERS)</span></th>
                      <th><?php echo $preview['column_to_column'];?></th>
                    </tr>
                    <tr>
             ...
             <!--    <div class="mb-3">
               ...
               <!--   <div class="mb-3">
                ...
                <button class="btn btn-success w-100" name="eot_payment" type="submit">PROCEED FOR PAYMENT AGAINST SUBSCRIPTION</button>
