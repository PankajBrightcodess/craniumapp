    ...
    <div class="container">
     <div class="row" style="margin-top:50px;">
       <div class="col-md-12 mb-5">
            <center>
                <strong><font size="+2">Cranium Services</font></strong><br />
     ...
     <a href="home.php"><button type="button" onclick="closeThis('<?php echo $pre; ?>');" class="btn btn-default">Close</button></a>
     </center></div>
