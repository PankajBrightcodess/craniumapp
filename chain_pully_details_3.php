                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                     ...
                     <td colspan="1" >                      
                      ...
                      <input type="hidden" name="model_no" value="CS-CPB-5T">
                    </td>
                    <td colspan="1" >                      
                    <select class="form-control" name="qty" id="rate_qnty">
                      <option value="">--SELECT--</option>
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">10,000.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="10000">
                    </td>
                     <td colspan="2" ><span><strong id="model_no">CS-CPB-5T</strong></span></td>
                  </tr>
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="extra_lift_total">0.00</span></strong>
                       <input type="text" name="extralift" id="extralift" value="0"> 
              <!--         <input type="hidden" name="total_val" value=""> -->  <!-- id="total" -->
                   ...
                   <tr>
                    ...
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="geared_trolley_total">0.00</span></strong>
                     ...
                     <td colspan="2" id="traviling_moter_no">CS-GT_CPB-5T
                      <input type="hidden" name="traviling_moter_no_val" value="CS-GT_CPB-5T">
                     </td>
                  </tr>
                   <tr>
                     <td colspan="3"><span><strong>BASIC TOTAL</strong></span></td>
                     
                    <td colspan="1"><strong><span>INR &nbsp;&nbsp;</span><span id="basic_total">0.00</span></strong><input type="hidden" value="10000" name="basic_total_val" id="basic_total_val" ></td>
                     <td colspan="2" ></td>
                  </tr>
                   <tr id="igst">
