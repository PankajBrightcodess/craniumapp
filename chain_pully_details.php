                ...
                <thead>
                  ...
                  <tr style="background: yellow; color: red;">
                   ...
                   <tr>
                    ...
                    <td colspan="1"><span><strong >INR <span id="rate">4,250.00</span></strong></span>
                      <input type="hidden" name="rate" id="rates"  value="4250">
                    </td>
                   ...
                   <tr>
                     ...
                     <select class="form-control" name="extra_lift_true_false" id="extra_lift_true_false"><option>--SELECT--</option><option value="1">Yes</option><option value="0">No</option></select></td>
                     <td colspan="1" >                      
