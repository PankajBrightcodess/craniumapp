                ...
                <div class="col-md-12 card p-3">
                    <div class="row">
                        <div class="col-6 col-md-6">
                            <h3><?php echo ucwords($row['company_owner']);?></h3>
                            <!-- <p class='mb-0' style='font-size:14px'><?php echo $row['name'];?></p> -->
                            <p class='mb-0' style='font-size:14px'>+91 <?php echo $row['contact'];?></p>
                        </div>
                        ...
                        <div class="col-md-6">
                            <u><h5>Request Details</h5></u>
                                ...
                                <div class="form-row">
                                    ...
                                    <p class='col-6 col-md-6 text-danger' style='font-size:20px;font-weight:600'>Rs.<?php echo $row['total_amounts_val'];?></p>
                                </div>
